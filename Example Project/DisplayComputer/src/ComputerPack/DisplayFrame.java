...
public class DisplayFrame extends javax.swing.JFrame {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(KeywordField, javax.swing.GroupLayout.PREFERRED_SIZE, 544, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(ComponentList, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(NameList, javax.swing.GroupLayout.PREFERRED_SIZE, 545, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(22, 22, 22)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(KeywordField, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(27, 27, 27)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ComponentList, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
                .addGap(12, 12, 12)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void ComponentListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComponentListActionPerformed
        ...
        try {
            ...
            queryString = "PREFIX ex:<http://localhost/computer#> "
            +"PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#> "
            + "SELECT  (str(?y) as ?NameComponent) "
            + "where { ?x rdf:type ex:"+selectValue+"."
            + "?x ex:name ?y."
            + " }";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String queryString;
               queryString = "PREFIX ex:<http://localhost/computer#> "
                             ...
                             + "SELECT  (str(?nameCom) as ?NameComputer) (str(?cpu) as ?CPU) (str(?ram) as ?RAM) "
                             + "where {?x ex:name ?gpu."
                             + "FILTER regex(?gpu, \""+KeywordFieldValue+"\")"
                             + "?y ex:hasGPU ?x."
                             + "?y ex:hasCPU ?c."
                             + "?y ex:hasRAM ?r."
                             + "?y ex:name ?nameCom."
